...
const API_BASE_URL = 'https://hackniche-extra-endpoints.onrender.com';
...
const AIAnalysisSidebar = ({ isOpen, onClose, documentContent }) => {
  ...
  const performAnalysis = async () => {
    ...
    try {
      ...
      const analysisResponse = await axiosInstance.post('/analyze', {
        script_text: documentContent
      });
      ...
      const reportResponse = await axiosInstance.get('/report');
      setReport(reportResponse.data);

      // Get readability score
      const readabilityResponse = await axiosInstance.get('/readability');
