...
// const AI_API_BASE_URL = 'https://2fsnqvm4-8000.inc1.devtunnels.ms/docs';
// Using proxy configured in vite.config.js
const AI_API_BASE_URL = 'https://hackniche-extra-endpoints.onrender.com';  // Empty string will use the current origin
