...
import { PencilAltIcon, DocumentTextIcon, UserGroupIcon, BookOpenIcon } from '@heroicons/react/outline';
        ...
        >
          ...
          <div className="flex justify-center space-x-4">
            ...
            >
              <Link
                to="/tutorials"
                className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-600 md:text-lg"
              >
                Writing Tutorials
